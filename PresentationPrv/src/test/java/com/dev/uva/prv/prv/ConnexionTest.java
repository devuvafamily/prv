...
package com.dev.uva.prv.prv;

import com.dev.uva.prv.accueil.Connexion;
import com.opensymphony.xwork2.ActionSupport;
import com.opensymphony.xwork2.config.entities.ActionConfig;

import java.util.Map;

public class ConnexionTest extends ConfigTest {

    public void FIXME_testLoginConfig() throws Exception {
        ActionConfig config = assertClass("prv", "connexion_input", "prv.connexion");
        assertResult(config, ActionSupport.SUCCESS, "Menu");
        assertResult(config, ActionSupport.INPUT, "/prv/connexion.jsp");
    }
